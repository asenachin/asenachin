...
1 📊 Исследовательский анализ данных (pandas).   
2 📈 Визуализация данных (seaborn, plotly, dash, datalens, tableau, power bi).      
3 🧮 Машинное обучение, статистический анализ и А/В-тестирование.      
4 🐍 Информационные системы (tkinter, aiogram, flask, django).  
