...
1 🥳 Делаю сайты на WordPress.  
2 🐍 Информационными системами на Python (tkinter, aiogram, flask, django).  
3 📊 Исследовательским анализом данных (pandas).     
4 📈 Визуализацией данных (seaborn, plotly, dash, datalens, tableau, power bi).        
5 🧮 Машинным обучением, статистическим анализом и А/В-тестированием.          
